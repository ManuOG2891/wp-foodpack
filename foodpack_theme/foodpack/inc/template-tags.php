...
if ( ! function_exists( 'foodpack_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function foodpack_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'foodpack' ),
...
if ( ! function_exists( 'foodpack_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function foodpack_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'foodpack' ),
...
if ( ! function_exists( 'foodpack_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function foodpack_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'foodpack' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'foodpack_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function foodpack_post_thumbnail() {
